"""
Code taken from https://github.com/scaperot/the-BPM-detector-python . Author: scaperot.
Based on the paper "Audio Analysis using the Discrete Wavelet Transform", http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.63.5712 .
"""
...
def get_bpm_from_audio(filename, window):
    ...
    for window_ndx in xrange(0,max_window_ndx):
        ...
        #iterate at the end of th   e loop
